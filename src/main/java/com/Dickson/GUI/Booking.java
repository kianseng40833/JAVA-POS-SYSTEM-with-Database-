...
public class Booking extends JFrame {
    ...
    public void initialComponent() {
        ...
        ImageIcon img1 = new ImageIcon("Table 1.jpg");
        table1 = createButton("1", img1);
        ImageIcon img2 = new ImageIcon("Table 2.jpg");
        table2 = createButton("2", img2);
        ImageIcon img3 = new ImageIcon("Table 3.jpg");
        table3 = createButton("3", img3);
        ImageIcon img4 = new ImageIcon("Table 4.jpg");
        table4 = createButton("4", img4);
        ImageIcon img5 = new ImageIcon("Table 5.jpg");
        table5 = createButton("5", img5);
        ImageIcon img6 = new ImageIcon("Table 6.jpg");
